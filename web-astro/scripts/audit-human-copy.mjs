...
const rules = [
  ...
  ["frase percorso spezzata", /\bPuò essere indicato se\s+Quando\b/giu],
  ...
  ["titolo trattamento generico", /\b(?:A quali esigenze è dedicato il trattamento|Prezzo e varianti del trattamento|Vuoi prenotare una seduta|Prenota il tuo appuntamento)\b/giu],
  ["formula assemblata o burocratica", /\b(?:soggetta a sensazioni di tensione|routine utilizzata a casa|percorso orientato alla|partire da una priorità|la sensazione resta soggettiva|la percezione viene verificata|prevista per il tuo importo|richiedi disponibilità e condizioni|singola zona a seduta|le tecnologie che può includere)\b/giu],
