...
const phraseRules: Array<[RegExp, string]> = [
  ...
  [/\bpunto di partenza utile\b/gi, "guida utile"],
  [/\bpunto di partenza\b/gi, "condizioni iniziali"],
  [/\bprima mossa\b/gi, "trattamento iniziale"],
  [/\bmossa\b/gi, "trattamento"],
  ...
  [/\brisultato pulito\b/gi, "risultato uniforme e ordinato"],
  [/\bsenza complicarti la settimana\b/gi, "con appuntamenti compatibili con i tuoi impegni"],
  [/\bcon le idee già più chiare\b/gi, "con informazioni su modalità e prezzi"],
  [/\bcosa significa davvero avanzata\b/gi, "quali trattamenti e tecnologie comprende l’estetica avanzata"],
  [/\bstep\b/gi, "fase"],
];
