...
export const rebelJourneys: RebelJourney[] = [
  {
    ...
    world: "glow",
    area: "Viso",
    summary: "Il trattamento che prepara la pelle prima di un percorso dedicato a esigenze più specifiche.",
    recognize: "Vuoi preparare una pelle spenta, ruvida o irregolare prima di un trattamento più specifico.",
    objective: "Detergere ed esfoliare la pelle in modo mirato, preparandola agli eventuali trattamenti successivi.",
    ...
    chapters: [
      { eyebrow: "01 · Osservare", title: "Prima del trattamento, osserviamo la pelle.", body: "Valutiamo grana, sensibilità e idratazione per capire come impostare la seduta." },
      ...
      { eyebrow: "03 · Continuare", title: "Dopo la seduta osserviamo come risponde la pelle.", body: "Da qui definiamo se proseguire con Barrier, Balance, Glow, White, Structure o Longevity." },
    ],
    actives: [
    ...
    technologies: [],
    technologyNote: "Skin Reset si basa soprattutto su prodotti cosmetici e tecniche manuali. Se aggiungere uno strumento può migliorare la seduta, te ne spieghiamo il motivo prima di procedere.",
  },
  {
    slug: "barrier",
    number: "02",
    ...
    recognize: "La pelle tira, appare disidratata o reagisce facilmente ai prodotti e ai cambiamenti di routine.",
    ...
    chapters: [
      { eyebrow: "01 · Ascoltare", title: "Ascoltiamo anche le sensazioni che ci descrivi.", body: "Oltre a osservare la pelle, consideriamo reattività, comfort e routine quotidiana." },
      { eyebrow: "02 · Sostenere", title: "Idratazione e lipidi, senza sovraccaricare.", body: "Scegliamo umettanti, ceramidi, lipidi ed estratti vegetali in base alle condizioni e alla sensibilità della pelle." },
    ...
    technologies: [],
    technologyNote: "Barrier si basa soprattutto su prodotti cosmetici e tecniche manuali. Valutiamo eventuali tecnologie solo se compatibili con la sensibilità della pelle.",
  },
  {
    slug: "balance",
    number: "03",
    ...
    recognize: "La pelle presenta lucidità, comedoni, impurità o una grana non uniforme.",
    objective: "Lavorare su lucidità, impurità, pori visibili e grana irregolare, rispettando la sensibilità della pelle.",
    duration: "circa 60 min",
    price: "da €79",
    priceNote: "Attivi, frequenza e prezzo vengono definiti dopo aver valutato sensibilità e caratteristiche della pelle.",
    ...
    chapters: [
      ...
      { eyebrow: "02 · Riequilibrare", title: "Acidi, minerali e fermenti scelti in base alla pelle.", body: "La combinazione viene definita in base alla zona e alla sensibilità della pelle." },
      { eyebrow: "03 · Stabilizzare", title: "Controlliamo la pelle tra una seduta e l’altra.", body: "Durante i controlli osserviamo come cambia la pelle e aggiorniamo intensità o frequenza quando necessario." },
    ],
    actives: [
    ...
    technologies: [],
    technologyNote: "Dermabrasione e ozono possono entrare nel percorso dopo la valutazione della pelle.",
  },
  {
    slug: "glow",
    number: "04",
    ...
    recognize: "La pelle appare spenta, stanca o poco uniforme.",
    objective: "Lavorare su luminosità e uniformità rispettando caratteristiche e sensibilità della pelle.",
    duration: "circa 60 min",
    price: "da €89",
    priceNote: "Il prezzo finale dipende dagli attivi scelti, dall’eventuale preparazione e dalle tecnologie concordate.",
    heroDesktopSlot: "home.hero.epigenetics.desktop",
    heroMobileSlot: "home.hero.epigenetics.mobile",
    heroAlt: "Professionista applica un siero durante un trattamento viso",
    chapters: [
      { eyebrow: "01 · Preparare", title: "Prepariamo la pelle al trattamento.", body: "Quando serve, Skin Reset prepara la pelle prima di iniziare Glow." },
      ...
      { eyebrow: "03 · Preservare", title: "Come accompagnare il percorso a casa.", body: "I controlli e una routine essenziale danno continuità al lavoro svolto in studio." },
    ],
    actives: [
  ...
  },
  {
    ...
    recognize: "Noti macchie o differenze di tono che rendono l’incarnato meno uniforme.",
    objective: "Lavorare sull’uniformità del tono rispettando sensibilità e caratteristiche della pelle.",
    duration: "circa 60 min",
    price: "da €99",
    priceNote: "Il prezzo della seduta viene confermato dopo la valutazione; gli eventuali prodotti per casa non sono inclusi.",
    heroDesktopSlot: "services.epigenetics.detail.desktop",
    heroMobileSlot: "services.epigenetics.detail.mobile",
    heroAlt: "Preparazione di un prodotto accanto alla cliente durante un trattamento viso",
    chapters: [
      ...
      { eyebrow: "03 · Proteggere", title: "Valutiamo anche la routine da seguire a casa.", body: "Ai controlli osserviamo i cambiamenti e, se utile, aggiorniamo la routine consigliata." },
    ],
    actives: [
  ...
  },
  {
    ...
    recognize: "La pelle appare meno tonica, elastica o compatta.",
    objective: "Lavorare su tono, elasticità e compattezza con attivi, tecniche manuali ed eventuali tecnologie scelti dopo la valutazione.",
    duration: "circa 60 min",
    price: "da €109",
    ...
    heroAlt: "Professionista applica un siero durante un trattamento viso",
    chapters: [
      { eyebrow: "01 · Definire", title: "Stabiliamo da quale esigenza partire.", body: "Durante la valutazione decidiamo se partire da attivi, tecniche manuali o tecnologia." },
      { eyebrow: "02 · Costruire", title: "Peptidi, acido ialuronico e tecniche manuali.", body: "Combiniamo attivi e tecniche manuali in base a come si presenta la pelle." },
      { eyebrow: "03 · Controllare", title: "Valutiamo i cambiamenti nel tempo.", body: "Tra una seduta e l’altra osserviamo come cambia la pelle e aggiorniamo il programma quando necessario." },
    ],
    actives: [
  ...
  },
  {
    ...
    recognize: "Vuoi prenderti cura della pelle nel tempo, con attenzione a idratazione, luminosità, tono ed elasticità.",
    objective: "Dare continuità alla cura della pelle con sedute, controlli e una routine adatta alle tue abitudini.",
    duration: "circa 60 min",
    price: "da €79",
    priceNote: "Seduta singola da €79. Formula mensile: due sedute a €149, con controllo cutaneo trimestrale incluso. Prodotti per casa esclusi.",
    ...
    chapters: [
      ...
      { eyebrow: "02 · Alternare", title: "Adattiamo ogni seduta a come cambia la pelle.", body: "In base a ciò che osserviamo, possiamo modificare prodotti, tecniche manuali o tecnologie." },
      { eyebrow: "03 · Preservare", title: "Diamo continuità al percorso.", body: "I controlli periodici ci permettono di aggiornare trattamenti e frequenza." },
    ],
    actives: [
  ...
  },
  {
    ...
    recognize: "Avverti pesantezza o vuoi lavorare su tono, compattezza e aspetto della silhouette.",
    objective: "Lavorare sulla priorità che hai scelto con un programma adatto alla zona e al tempo che puoi dedicargli.",
    duration: "60–90 min",
    price: "da €79",
    priceNote: "Pacchetti disponibili: Start, 10 sedute a €690; Advanced, 15 sedute a €960; Top, 20 sedute a €1.180.",
    ...
    chapters: [
      { eyebrow: "01 · Valutare", title: "Partiamo da ciò che vuoi migliorare.", body: "Osserviamo la zona, il tono, le sensazioni che avverti, le tue abitudini e il tempo disponibile." },
      { eyebrow: "02 · Programmare", title: "Scegliamo come intervenire.", body: "Combiniamo attivi, manualità ed eventuali tecnologie in base alla priorità emersa durante la valutazione." },
      { eyebrow: "03 · Controllare", title: "Seguiamo i cambiamenti nel tempo.", body: "Durante i controlli possiamo modificare sequenza, intensità e frequenza quando serve." },
    ],
    actives: [
  ...
  },
  {
    ...
    world: "liberta",
    area: "Epilazione",
    summary: "Un percorso di epilazione progressiva definito in base alla zona, al fototipo, alle caratteristiche del pelo e al calendario delle sedute.",
    recognize: "Desideri ridurre progressivamente la ricrescita e semplificare la gestione quotidiana.",
    objective: "Lavorare sulla riduzione progressiva della ricrescita con parametri e frequenza definiti in base alla zona e al ciclo del pelo.",
    duration: "variabile in base alla zona",
    price: "da €25,90 a zona",
    priceNote: "Il prezzo ordinario parte da €25,90 per una singola zona e varia in base all’estensione. Frequenza e numero di sedute vengono definiti dopo la valutazione; le condizioni delle promozioni sono confermate al momento della richiesta.",
    ...
    chapters: [
      { eyebrow: "01 · Valutare", title: "Prima la pelle e il pelo, poi i parametri.", body: "Prima della prima seduta valutiamo zona, fototipo, caratteristiche del pelo, rasatura, esposizione solare e prodotti usati sulla pelle." },
      ...
      { eyebrow: "03 · Accompagnare", title: "Comfort durante la seduta, cura della pelle dopo il trattamento.", body: "ICE Polar raffredda la pelle a contatto durante la seduta; al termine valutiamo se consigliare un prodotto cosmetico per la zona trattata." },
    ],
    actives: [
