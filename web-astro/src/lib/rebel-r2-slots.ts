...
export const SLOT_RULES: SlotRule[] = [
  ...
  },
  {
    ...
    keywords: ["hero"],
    variant: "any",
    label: "THORY · Lumina X3",
  },
  {
    slot: "technologies.thory.luminaK3",
    prefixes: ["rebel/technologies/thory/lumina-k3/"],
    keywords: ["hero"],
    variant: "any",
    label: "THORY · Lumina K3",
  },
  {
    slot: "technologies.thory.auraQ2",
    prefixes: ["rebel/technologies/thory/aura-q2/"],
    keywords: ["hero"],
    variant: "any",
    label: "THORY · Aura Q2",
  },
  {
    slot: "technologies.thory.cryoShapeX2",
    prefixes: ["rebel/technologies/thory/cryoshape-x2/"],
    keywords: ["hero"],
    variant: "any",
    label: "THORY · CryoShape X2",
  },
  {
    slot: "technologies.thory.infraPressX2",
    prefixes: ["rebel/technologies/thory/infrapress-x2/"],
    keywords: ["hero"],
    variant: "any",
    label: "THORY · InfraPress X2",
  },
  {
    slot: "technologies.thory.tecar448",
    prefixes: ["rebel/technologies/thory/tecar-448-revolution/"],
    keywords: ["hero"],
    variant: "any",
    label: "THORY · Tecar 448Revolution",
  },
  {
