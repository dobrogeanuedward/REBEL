...
export const thoryTechnologies: RebelTechnology[] = [
  ...
  },
  {
    ...
    summary: "Due applicatori possono lavorare su aree diverse nella stessa seduta, quando previsto dal programma corpo Forma.",
  ...
  },
  {
    ...
    summary: "Compressione pneumatica sequenziale e infrarosso possono essere combinati nello stesso programma corpo. Regoliamo zone e intensità in base alle tue sensazioni.",
  ...
  },
  {
    ...
    descriptor: "Modalità capacitiva e resistiva",
    technicalDescriptor: "Sistema di diatermia CET e RET a 448 kHz",
    headline: "Due modalità a 448 kHz, scelte in base alla zona.",
    summary: "Le modalità capacitiva e resistiva lavorano a 448 kHz. Scegliamo quella adatta alla zona e al trattamento previsto.",
    ...
    note: "La modalità viene scelta in base alla zona e all’obiettivo concordato.",
    reviewLevel: "approved",
  },
];
